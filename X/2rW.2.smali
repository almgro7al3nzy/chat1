...
.method public A00(B[BII)V
    ...
    iget-object v0, v1, LX/3Gl;->A01:LX/2r7;

    invoke-interface {v0}, LX/2r7;->A7J()LX/03K;

    add-int/lit8 v0, v13, 0x10

    invoke-static {v0}, LX/0DO;->A26(I)[B

    move-result-object v0

    invoke-virtual {v6, v0}, Ljava/nio/ByteBuffer;->put([B)Ljava/nio/ByteBuffer;

    iget-object v7, v1, LX/3Gl;->A01:LX/2r7;

    iget-wide v8, v1, LX/3Gl;->A00:J
    ...
    invoke-interface/range {v7 .. v13}, LX/2r7;->A3f(J[B[BII)[B

    move-result-object v9

    iget-wide v7, v1, LX/3Gl;->A00:J

    const-wide/16 v4, 0x1

    add-long/2addr v7, v4

    iput-wide v7, v1, LX/3Gl;->A00:J
    ...
    iget-object v1, v1, LX/3Gl;->A02:Ljava/io/OutputStream;
    ...
    invoke-direct {v1, v4, v0, v3}, LX/0DW;-><init>(BLjavax/net/ssl/SSLException;Z)V
    ...
    invoke-static {v1, v5, v0, v8}, LX/00P;->A09(Ljava/lang/String;ILjava/lang/String;I)Ljava/lang/String;
    ...
    iget-boolean v0, v1, LX/3H7;->A01:Z

    if-nez v0, :cond_2

    iput-boolean v4, v1, LX/3H7;->A01:Z

    sget-object v0, LX/0IJ;->A00:Ljava/lang/Short;
    ...
    :goto_1
    invoke-static {v5}, LX/0DO;->A26(I)[B
    ...
    iget-object v1, v1, LX/3H7;->A00:Ljava/io/OutputStream;
    ...
    invoke-static {v1, v5, v0, v4}, LX/00P;->A09(Ljava/lang/String;ILjava/lang/String;I)Ljava/lang/String;

    move-result-object v0

    invoke-direct {v2, v0}, Ljavax/net/ssl/SSLException;-><init>(Ljava/lang/String;)V

    invoke-direct {v3, v8, v2}, LX/0DW;-><init>(BLjavax/net/ssl/SSLException;)V
...
.method public declared-synchronized A01(B[BII)V
    ...
    invoke-virtual {p0, p1, p2, p3, v0}, LX/2rW;->A00(B[BII)V
    ...
    invoke-virtual {p0, p1, p2, p3, p4}, LX/2rW;->A00(B[BII)V
    :try_end_0
