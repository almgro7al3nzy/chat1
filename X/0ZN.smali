...
.method public A00([BII)V
    ...
    :try_start_0
    iget-object v1, v5, LX/0ZR;->A02:[B
    ...
    iget v3, v2, LX/0ZT;->A02:I

    iget v1, v2, LX/0ZT;->A00:I

    sub-int/2addr v3, v1

    if-lt v3, p3, :cond_1

    iget-object v0, v2, LX/0ZT;->A03:[B
    ...
    invoke-virtual {v2}, LX/0ZS;->A0S()V

    iget v0, v2, LX/0ZT;->A02:I

    if-gt p3, v0, :cond_2

    iget-object v1, v2, LX/0ZT;->A03:[B

    const/4 v0, 0x0

    invoke-static {p1, p2, v1, v0, p3}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V

    iput p3, v2, LX/0ZT;->A00:I
    ...
    :cond_2
    iget-object v0, v2, LX/0ZS;->A00:Ljava/io/OutputStream;
