...
.method public constructor <init>(Landroid/content/Intent;Landroid/content/BroadcastReceiver$PendingResult;Ljava/util/concurrent/ScheduledExecutorService;)V
    ...
    iput-boolean v0, p0, LX/1Ct;->A00:Z

    iput-object p1, p0, LX/1Ct;->A02:Landroid/content/Intent;

    iput-object p2, p0, LX/1Ct;->A01:Landroid/content/BroadcastReceiver$PendingResult;

    new-instance v3, LX/1Cs;

    invoke-direct {v3, p0, p1}, LX/1Cs;-><init>(LX/1Ct;Landroid/content/Intent;)V
    ...
    iput-object v0, p0, LX/1Ct;->A03:Ljava/util/concurrent/ScheduledFuture;
...
.method public final declared-synchronized A00()V
    ...
    :try_start_0
    iget-boolean v0, p0, LX/1Ct;->A00:Z

    if-nez v0, :cond_0

    iget-object v0, p0, LX/1Ct;->A01:Landroid/content/BroadcastReceiver$PendingResult;

    invoke-virtual {v0}, Landroid/content/BroadcastReceiver$PendingResult;->finish()V

    iget-object v1, p0, LX/1Ct;->A03:Ljava/util/concurrent/ScheduledFuture;
