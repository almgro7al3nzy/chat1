...
# direct methods
.method public synthetic constructor <init>(LX/2Si;LX/2Sj;Ljava/util/Map;ZLX/36Q;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, LX/1rX;->A00:LX/2Si;

    iput-object p2, p0, LX/1rX;->A01:LX/2Sj;

    iput-object p3, p0, LX/1rX;->A03:Ljava/util/Map;

    iput-boolean p4, p0, LX/1rX;->A04:Z

    iput-object p5, p0, LX/1rX;->A02:LX/36Q;
...
.method public final run()V
    ...
    iget-object v11, v1, LX/1rX;->A00:LX/2Si;

    iget-object v13, v1, LX/1rX;->A01:LX/2Sj;

    iget-object v0, v1, LX/1rX;->A03:Ljava/util/Map;

    move-object/from16 v25, v0

    iget-boolean v12, v1, LX/1rX;->A04:Z

    iget-object v0, v1, LX/1rX;->A02:LX/36Q;
    ...
    :try_start_0
    iget-object v8, v13, LX/2Sj;->A01:LX/0KY;

    iget-object v0, v11, LX/2Si;->A0D:Ljava/util/concurrent/atomic/AtomicBoolean;

    move-object/from16 v23, v0

    iget-object v3, v8, LX/0KY;->A07:Lorg/json/JSONObject;
    ...
    invoke-virtual {v9, v2}, LX/36Q;->A01(Ljava/lang/Object;)Z
    ...
    invoke-static {v9, v12}, LX/00P;->A14(Ljava/lang/StringBuilder;Z)V
    ...
    :cond_4
    iget-wide v8, v8, LX/0KY;->A02:J

    sub-long/2addr v8, v0

    iget-object v0, v11, LX/2Si;->A01:LX/0AR;
    ...
    :cond_7
    iget-object v15, v11, LX/2Si;->A00:LX/00q;

    iget-object v14, v11, LX/2Si;->A03:LX/02K;

    iget-object v0, v11, LX/2Si;->A04:LX/00j;
    ...
    iget-object v1, v11, LX/2Si;->A03:LX/02K;

    iget-object v0, v11, LX/2Si;->A05:LX/00c;

    invoke-static {v15, v14, v1, v0}, LX/063;->A08(Ljava/lang/String;LX/0JF;LX/02K;LX/00c;)I
    ...
    invoke-virtual {v14, v0}, LX/36Q;->A01(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v0, v1}, LX/36Q;->A01(Ljava/lang/Object;)Z

    if-eqz v12, :cond_12

    iget-object v0, v13, LX/2Sj;->A01:LX/0KY;

    iget-object v3, v0, LX/0KY;->A07:Lorg/json/JSONObject;
    ...
    :goto_8
    iget-object v0, v11, LX/2Si;->A0C:Ljava/lang/ref/WeakReference;

    invoke-virtual {v0}, Ljava/lang/ref/WeakReference;->get()Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Lcom/akwhatsapp/gdrive/RestoreFromBackupActivity;

    if-eqz v0, :cond_13

    invoke-virtual {v0, v4, v5, v1, v2}, Lcom/akwhatsapp/gdrive/RestoreFromBackupActivity;->A0g(JJ)V
