...
.method public A00(Ljava/lang/Object;)Landroid/view/View;
    ...
    :cond_0
    new-instance v1, Lcom/akwhatsapp/payments/ui/widget/PaymentTransactionRow;

    invoke-virtual {v3}, Landroid/widget/LinearLayout;->getContext()Landroid/content/Context;

    move-result-object v0

    invoke-direct {v1, v0}, Lcom/akwhatsapp/payments/ui/widget/PaymentTransactionRow;-><init>(Landroid/content/Context;)V
...
.method public A02(Ljava/lang/Object;Landroid/view/View;II)V
    ...
    check-cast v2, Lcom/akwhatsapp/payments/ui/widget/TransactionsExpandableView;

    check-cast p1, LX/0Gt;

    instance-of v0, p2, Lcom/akwhatsapp/payments/ui/widget/PaymentTransactionRow;

    if-eqz v0, :cond_1

    move-object v1, p2

    check-cast v1, Lcom/akwhatsapp/payments/ui/widget/PaymentTransactionRow;

    if-eqz p1, :cond_3

    iget-object v0, v2, Lcom/akwhatsapp/payments/ui/widget/TransactionsExpandableView;->A00:LX/1vy;

    invoke-virtual {v1, p1, v0}, Lcom/akwhatsapp/payments/ui/widget/PaymentTransactionRow;->A01(LX/0Gt;LX/1vy;)V
    ...
    :cond_1
    instance-of v0, p2, Lcom/akwhatsapp/payments/ui/widget/PaymentInteropShimmerRow;
    ...
    invoke-virtual {v0, p1}, Lcom/akwhatsapp/payments/ui/widget/PaymentInteropShimmerRow;->A01(LX/0Gt;)V
