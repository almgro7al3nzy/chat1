...
# static fields
.field public static final A07:[LX/1mD;
...
.method public static constructor <clinit>()V
    ...
    invoke-direct/range {v2 .. v8}, LX/1mD;-><init>(FFFFFF)V
    ...
    const/high16 v7, 0x438e0000    # 284.0f
    ...
    const/high16 v5, 0x44260000    # 664.0f
    ...
    sput-object v0, LX/2Oc;->A07:[LX/1mD;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, LX/2Oc;->A01:Landroid/graphics/Paint;

    new-instance v0, Landroid/graphics/Matrix;

    invoke-direct {v0}, Landroid/graphics/Matrix;-><init>()V

    iput-object v0, p0, LX/2Oc;->A00:Landroid/graphics/Matrix;

    new-instance v0, Landroid/graphics/RectF;

    invoke-direct {v0}, Landroid/graphics/RectF;-><init>()V

    iput-object v0, p0, LX/2Oc;->A05:Landroid/graphics/RectF;

    new-instance v0, Landroid/graphics/Path;

    invoke-direct {v0}, Landroid/graphics/Path;-><init>()V

    iput-object v0, p0, LX/2Oc;->A04:Landroid/graphics/Path;

    new-instance v0, Landroid/graphics/RectF;

    invoke-direct {v0}, Landroid/graphics/RectF;-><init>()V

    iput-object v0, p0, LX/2Oc;->A06:Landroid/graphics/RectF;

    new-instance v11, Landroid/graphics/Path;

    invoke-direct {v11}, Landroid/graphics/Path;-><init>()V

    sget-object v8, LX/2Oc;->A07:[LX/1mD;
    ...
    iget v4, v6, LX/1mD;->A01:F

    iget v2, v6, LX/1mD;->A05:F

    iget v1, v6, LX/1mD;->A02:F

    iget v0, v6, LX/1mD;->A00:F

    invoke-direct {v5, v4, v2, v1, v0}, Landroid/graphics/RectF;-><init>(FFFF)V

    iget v1, v6, LX/1mD;->A03:F

    iget v0, v6, LX/1mD;->A04:F

    invoke-virtual {v11, v5, v1, v0}, Landroid/graphics/Path;->addArc(Landroid/graphics/RectF;FF)V
    ...
    :cond_0
    iput-object v11, p0, LX/2Oc;->A03:Landroid/graphics/Path;
    ...
    iget v4, v0, LX/1mD;->A01:F

    iget v2, v0, LX/1mD;->A05:F

    iget v1, v0, LX/1mD;->A02:F

    iget v0, v0, LX/1mD;->A00:F

    invoke-direct {v5, v4, v2, v1, v0}, Landroid/graphics/RectF;-><init>(FFFF)V

    sget-object v0, Landroid/graphics/Path$Direction;->CW:Landroid/graphics/Path$Direction;

    invoke-virtual {v9, v5, v0}, Landroid/graphics/Path;->addOval(Landroid/graphics/RectF;Landroid/graphics/Path$Direction;)V
    ...
    iput-object v9, p0, LX/2Oc;->A02:Landroid/graphics/Path;

    iget-object v1, p0, LX/2Oc;->A03:Landroid/graphics/Path;
...
.method public final A0R(Landroid/graphics/Canvas;FF)V
    .locals 10
    ...
    iget-object v2, p0, LX/2Oc;->A06:Landroid/graphics/RectF;
    ...
    invoke-virtual {v2, v1, v0, v4, p2}, Landroid/graphics/RectF;->set(FFFF)V

    iget-object v1, p0, LX/2Oc;->A06:Landroid/graphics/RectF;

    iget-object v0, p0, LX/2Oc;->A01:Landroid/graphics/Paint;
