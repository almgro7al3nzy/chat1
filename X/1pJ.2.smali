...
# direct methods
.method public synthetic constructor <init>(Lcom/akwhatsapp/gdrive/GoogleDriveService;Ljava/io/File;Ljava/util/concurrent/atomic/AtomicReference;Ljava/util/List;ZLjava/util/concurrent/CountDownLatch;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, LX/1pJ;->A00:Lcom/akwhatsapp/gdrive/GoogleDriveService;
...
.method public final run()V
    ...
    iget-object v6, p0, LX/1pJ;->A00:Lcom/akwhatsapp/gdrive/GoogleDriveService;
    ...
    :try_start_0
    iget-object v0, v6, Lcom/akwhatsapp/gdrive/GoogleDriveService;->A0V:LX/02K;
    ...
    :cond_0
    :try_start_1
    iget-object v0, v6, Lcom/akwhatsapp/gdrive/GoogleDriveService;->A0B:LX/1rU;
    ...
    iget-object v0, v6, Lcom/akwhatsapp/gdrive/GoogleDriveService;->A0k:LX/0K3;
    ...
    :try_start_2
    iget-object v1, v6, Lcom/akwhatsapp/gdrive/GoogleDriveService;->A0B:LX/1rU;
    ...
    :cond_3
    iget-object v2, v6, Lcom/akwhatsapp/gdrive/GoogleDriveService;->A10:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    :cond_4
    :try_start_4
    iget-object v0, v6, Lcom/akwhatsapp/gdrive/GoogleDriveService;->A0f:LX/08f;
    ...
    iget-object v4, v6, Lcom/akwhatsapp/gdrive/GoogleDriveService;->A0h:LX/2SK;

    iget-object v0, v6, Lcom/akwhatsapp/gdrive/GoogleDriveService;->A10:Ljava/util/concurrent/atomic/AtomicLong;

    invoke-virtual {v0}, Ljava/util/concurrent/atomic/AtomicLong;->get()J

    move-result-wide v2

    iget-wide v0, v6, Lcom/akwhatsapp/gdrive/GoogleDriveService;->A03:J
