...
.field private final synthetic A01:LX/00r;

.field private final synthetic A02:LX/01J;


# direct methods
.method public synthetic constructor <init>(LX/00r;Landroid/app/Activity;LX/01J;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, LX/0eo;->A01:LX/00r;

    iput-object p2, p0, LX/0eo;->A00:Landroid/app/Activity;

    iput-object p3, p0, LX/0eo;->A02:LX/01J;
...
.method public final createNdefMessage(Landroid/nfc/NfcEvent;)Landroid/nfc/NdefMessage;
    ...
    iget-object v10, p0, LX/0eo;->A01:LX/00r;

    iget-object v9, p0, LX/0eo;->A00:Landroid/app/Activity;

    iget-object v11, p0, LX/0eo;->A02:LX/01J;
    ...
    iget-object v0, v10, LX/00r;->A03:Lcom/whatsapp/jid/UserJid;
    ...
    invoke-static {v11, v10}, LX/0EQ;->A08(LX/01J;LX/00r;)Ljava/lang/String;
    ...
    invoke-virtual {v10}, LX/00r;->A02()Ljava/lang/String;

    move-result-object v0

    invoke-virtual {v8, v1, v0}, Lorg/json/JSONObject;->put(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;

    const-class v10, LX/0eu;
    ...
    invoke-static {v9}, LX/0eu;->A00(Landroid/content/Context;)V

    :cond_0
    sget-object v1, LX/0eu;->A00:Ljava/util/List;
    ...
    :cond_1
    invoke-static {v9}, LX/0eu;->A01(Landroid/content/Context;)V
    :try_end_1
